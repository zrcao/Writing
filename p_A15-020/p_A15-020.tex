...
\subsection{Research and Develop An Self-organizing Interference Alignment (SOIA)}
...
To evaluate system performance, a performance metric has to be defined first.
...
{\subsection{Design Protocol Frame Structure}}
